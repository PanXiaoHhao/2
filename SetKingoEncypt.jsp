    ...
    var _deskey = '97950176546005669811493';
var _nowtime = '2025-12-11 21:34:16';
var _ssessionid = 'FDB381A57909512D927A1BF754C8C154';
document.write("<script type='text/javascript' src='/rzzyjw/custom/js/base64.js'></script>");
document.write("<script type='text/javascript' src='/rzzyjw/custom/js/md5.js'></script>");
document.write("<script type='text/javascript' src='/rzzyjw/custom/js/jkingo.des.js'></script>");
